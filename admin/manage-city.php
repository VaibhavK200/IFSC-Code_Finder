...
<html lang="en">
    ...
    <head>
        ...
        <title>Coworking Space Management System :: Manage City</title>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">Manage City</h4>
                            

                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                <tr><th>#</th><th>State Name</th>
                                                    <th>City Name</th>
                                                    <th>Creation Date</th>
                                                    <th>Action</th>
                                                </tr>
...
$sql="SELECT tblstate.State ,tblcity.ID as cid,tblcity.City,tblcity.CreationDate from tblcity inner join tblstate on tblstate.ID=tblcity.StateID LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
